    ...
    <div class="inner">
        ...
        <div id="faqs">
            ...
            <div class="faq">
                ...
                <p class="faq-answer">No, provided that Keys Car Rental has not dispatched a vehicle at the time you cancel.</p>
            </div>
            <div class="faq">
                <div class="faq-top">
                    <div class="faq-toggle"></div>
                ...
                <p class="faq-answer">The start time of the rental period shall be at the actual delivery and acceptance by the individual of the vehicle. The ending time shall be at the end of rental time period. Keys Car Rental will make prior arrangements for pick ups and drop offs at locations most convenient for you.</p>
            </div>
            <div class="faq">
                <div class="faq-top">
                    <div class="faq-toggle"></div>
